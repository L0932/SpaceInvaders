...
// gpgl.h -- machine-insulated OpenGL include
#ifndef GPGL_H
#define GPGL_H
...
//
// OpenGL extension functions addresses populated by qe
//
...
GLAPI PFNGLISRENDERBUFFEREXTPROC glIsRenderbuffer;
GLAPI PFNGLISRENDERBUFFEREXTPROC glIsRenderbufferEXT;
GLAPI PFNGLBINDRENDERBUFFEREXTPROC glBindRenderbuffer;
GLAPI PFNGLBINDRENDERBUFFEREXTPROC glBindRenderbufferEXT;
GLAPI PFNGLDELETERENDERBUFFERSEXTPROC glDeleteRenderbuffers;
GLAPI PFNGLDELETERENDERBUFFERSEXTPROC glDeleteRenderbuffersEXT;
GLAPI PFNGLGENRENDERBUFFERSEXTPROC glGenRenderbuffers;
GLAPI PFNGLGENRENDERBUFFERSEXTPROC glGenRenderbuffersEXT;
GLAPI PFNGLRENDERBUFFERSTORAGEEXTPROC glRenderbufferStorage;
GLAPI PFNGLRENDERBUFFERSTORAGEEXTPROC glRenderbufferStorageEXT;
GLAPI PFNGLGETRENDERBUFFERPARAMETERIVEXTPROC glGetRenderbufferParameteriv;
GLAPI PFNGLGETRENDERBUFFERPARAMETERIVEXTPROC glGetRenderbufferParameterivEXT;
GLAPI PFNGLISFRAMEBUFFEREXTPROC glIsFramebuffer;
GLAPI PFNGLISFRAMEBUFFEREXTPROC glIsFramebufferEXT;
GLAPI PFNGLBINDFRAMEBUFFEREXTPROC glBindFramebuffer;
GLAPI PFNGLBINDFRAMEBUFFEREXTPROC glBindFramebufferEXT;
GLAPI PFNGLDELETEFRAMEBUFFERSEXTPROC glDeleteFramebuffers;
GLAPI PFNGLDELETEFRAMEBUFFERSEXTPROC glDeleteFramebuffersEXT;
GLAPI PFNGLGENFRAMEBUFFERSEXTPROC glGenFramebuffers;
GLAPI PFNGLGENFRAMEBUFFERSEXTPROC glGenFramebuffersEXT;
GLAPI PFNGLCHECKFRAMEBUFFERSTATUSEXTPROC glCheckFramebufferStatus;
GLAPI PFNGLCHECKFRAMEBUFFERSTATUSEXTPROC glCheckFramebufferStatusEXT;
GLAPI PFNGLFRAMEBUFFERTEXTURE1DEXTPROC glFramebufferTexture1D;
GLAPI PFNGLFRAMEBUFFERTEXTURE1DEXTPROC glFramebufferTexture1DEXT;
GLAPI PFNGLFRAMEBUFFERTEXTURE2DEXTPROC glFramebufferTexture2D;
GLAPI PFNGLFRAMEBUFFERTEXTURE2DEXTPROC glFramebufferTexture2DEXT;
GLAPI PFNGLFRAMEBUFFERTEXTURE3DEXTPROC glFramebufferTexture3D;
GLAPI PFNGLFRAMEBUFFERTEXTURE3DEXTPROC glFramebufferTexture3DEXT;
GLAPI PFNGLFRAMEBUFFERRENDERBUFFEREXTPROC glFramebufferRenderbuffer;
GLAPI PFNGLFRAMEBUFFERRENDERBUFFEREXTPROC glFramebufferRenderbufferEXT;
GLAPI PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVEXTPROC glGetFramebufferAttachmentParameteriv;
GLAPI PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVEXTPROC glGetFramebufferAttachmentParameterivEXT;
GLAPI PFNGLGENERATEMIPMAPEXTPROC glGenerateMipmap;
...
GP_API int qeShaderMapVars(int prg,qeShaderVarRec *vars); // return of mapping errors
